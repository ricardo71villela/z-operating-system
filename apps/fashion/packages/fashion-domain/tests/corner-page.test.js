...
const products = [
  createProduct({ id: 'p1', partnerId: 'partner_atelier', brandId: 'brand_atelier', names: { fr: 'Produit test' }, gender: 'unisex', categories: ['accessories_leather_goods'] }),
  createProduct({ id: 'p2', partnerId: 'partner_atelier', brandId: 'brand_atelier', names: { fr: 'Produit test' }, gender: 'unisex', categories: ['clothing'], size: { system: 'FR', value: 38 } }),
  createProduct({ id: 'p3', partnerId: 'partner_other', brandId: 'brand_other', names: { fr: 'Produit test' }, gender: 'unisex', categories: ['footwear'], size: { system: 'EU', value: 40 } }),
];
...
const withExclusive = [
  ...products.slice(0, 2),
  createProduct({ id: 'p4', partnerId: 'partner_atelier', brandId: 'brand_atelier', names: { fr: 'Produit test' }, gender: 'unisex', categories: ['clothing'], size: { system: 'FR', value: 40 }, cornerExclusive: true }),
];
...
const orphanProducts = [createProduct({ id: 'p5', partnerId: 'partner_atelier', brandId: 'brand_unknown', names: { fr: 'Produit test' }, gender: 'unisex', categories: ['clothing'], size: { system: 'FR', value: 38 } })];
