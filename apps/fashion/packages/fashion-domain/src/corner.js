...
/**
 * The cross-Partner All Sale view, filterable by Segment × Category ×
 * Brand × Partner (all optional). Excludes cornerExclusive Products —
 * All Sale is comprehensive by default (opt-out, not opt-in).
 */
