...
(function (root, factory) {
  ...
  const COPY = Object.freeze({
    ...
    en: Object.freeze({
      ...
      mapOmissionNote: 'Non-mainland territories are not represented on this map.',
    ...
    pt: Object.freeze({
      ...
      mapOmissionNote: 'Os territórios não continentais não estão representados neste mapa.',
    ...
    es: Object.freeze({
      ...
      mapOmissionNote: 'Los territorios no continentales no están representados en este mapa.',
    ...
    de: Object.freeze({
      ...
      mapOmissionNote: 'Nicht zum Festland gehörende Gebiete sind auf dieser Karte nicht dargestellt.',
    ...
    it: Object.freeze({
      ...
      mapOmissionNote: 'I territori non continentali non sono rappresentati in questa mappa.',
  ...
  const MAP_OMISSION_NOTE_MARKETS = Object.freeze([
    'PT','ES','FR','DE','IT','NL',
    'MX','BR','AR','CL','GR','HR'
  ]);
  ...
  function market(
    ...
    return Object.freeze({
      ...
      mapOmitsNonMainland: MAP_OMISSION_NOTE_MARKETS.includes(key),
  ...
  function marketPresentation(key, localeValue) {
    ...
    return Object.freeze({
      ...
      mapOmissionNote: copy.mapOmissionNote,
