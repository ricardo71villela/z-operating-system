...
- [SYSTEM-MODEL.md](./SYSTEM-MODEL.md) — how domains relate to one another as a network.
- [DOMAIN-MODEL.md](./DOMAIN-MODEL.md) — what qualifies as a domain, and key boundary rules (including Registry vs. Data).
...
## Related Domains
- All domains (this is the root of intent for the rest of the repository)
